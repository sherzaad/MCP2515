...
//CAN Speed Setup (predefined for 16MHz. No need to input cnf2 and cnf3 in 'init')
#define CANSPEED_125kBPS 	7		// CAN speed at 125 kbps
#define CANSPEED_250kBPS  	3		// CAN speed at 250 kbps
#define CANSPEED_500kBPS	1		// CAN speed at 500 kbps
#define CANSPEED_1000kBPS	0		// CAN speed at 1000 kbps
 ...
 *
 * The redundant addresses as registers CANSTAT (0x0E, 0x1E, 0x2E, ...) have not been defined here.
 */
/*@{*/
...
/** \Bits defined for CNF3 */
#define WAKFIL		6
#define PHSEG22		2
#define PHSEG21		1
#define PHSEG20		0

/** \Bits defined for CNF2 */
#define BTLMODE		7
#define SAM			6
#define PHSEG12		5
#define PHSEG11		4
...
/** \Bits defined for TXBnCTRL (n = 0, 1, 2) */
#define ABTF		6
#define MLOA		5
#define TXERR		4
#define TXREQ		3
...
/** \Bits defined for TXBnSIDL (n = 0, 1) */
#define	EXIDE		3

/**
 * \Bits defined for RXB1CTRL
 * \see	RXM1, RXM0, RXRTR and FILHIT0 already defined in RXB0CTRL
 */
#define FILHIT2		2
#define FILHIT1		1

/** \Bits defined for RXBnSIDL (n = 0, 1) */
#define	SRR			4
#define	IDE			3

/**
 * \Bits defined for RXBnDLC (n = 0, 1)
